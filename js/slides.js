(function($){
   ...
   * 
   * TODO: сделать так, чтобы этот метод вызывал все возможные индикаторы
   * и убрать навигационный индикатор из навигационного виджета
   */
